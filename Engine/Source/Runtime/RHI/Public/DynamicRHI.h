...
public:
	...
	virtual void RHIGpuTimeBegin(uint32 Hash,bool bCompute) = 0;

	// FlushType: Flush Immediate
	virtual void RHIGpuTimeEnd(uint32 Hash,bool bCompute) = 0;
	...
	*/
	 ...
	 */
	// FlushType: Wait RHI Thread
	virtual bool RHIIsDrawingViewport() = 0;
	...
	// FlushType: Thread safe
	virtual void RHISuspendRendering() = 0;

	// FlushType: Thread safe
	virtual void RHIResumeRendering() = 0;

	// FlushType: Flush Immediate
	virtual bool RHIIsRenderingSuspended() = 0;
	...
	// FlushType: Thread safe
	virtual class IRHICommandContext* RHIGetDefaultContext() = 0;
